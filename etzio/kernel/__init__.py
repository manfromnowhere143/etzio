...
and ``store``; it is intentionally imported explicitly so modeled and durable objects
cannot be confused. Receipt admission and lease recovery remain modeled-fixture scoped
and do not mint a finding.
"""
