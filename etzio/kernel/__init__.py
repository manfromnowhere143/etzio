...
``artifact_resolution``, ``reducer``, and ``store``; it is intentionally imported
explicitly so modeled and durable objects cannot be confused. Kernel-integrated verifier
