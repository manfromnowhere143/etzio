...
protocol-v1 fixture path lives in ``fixture_scan``, ``events_v1``, ``reducer``, and
``store``; it is intentionally imported explicitly so modeled and durable objects cannot
be confused. Kernel-integrated verifier receipts remain open.
"""
